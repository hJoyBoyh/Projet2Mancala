...
class Mancala_UI:
    def __init__(self):
        ...
        self.puits.append(Puit("L", 536, 210, 4 ,("images/4.jpg")))
        self.puits.append(Puit("K", 478, 210, 4 ,("images/4.jpg")))
        self.puits.append(Puit("J", 417, 210, 4 ,("images/4.jpg")))
        self.puits.append(Puit("I", 319, 210, 4 ,("images/4.jpg")))
        self.puits.append(Puit("H", 259, 210, 4 ,("images/4.jpg")))
        self.puits.append(Puit("G", 198, 210, 4 ,("images/4.jpg")))
